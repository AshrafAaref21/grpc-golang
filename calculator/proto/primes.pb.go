...
func (x *PrimesRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
const file_primes_proto_rawDesc = "" +
	...
	"\fprimes.proto\x12\n" +
	"calculator\"%\n" +
	"\rPrimesRequest\x12\x14\n" +
	"\x05limit\x18\x01 \x01(\x05R\x05limit\"&\n" +
	"\x0ePrimesResponse\x12\x14\n" +
	"\x05prime\x18\x01 \x01(\x05R\x05primeB7Z5github.com/AshrafAaref21/grpc-golang/calculator/protob\x06proto3"
