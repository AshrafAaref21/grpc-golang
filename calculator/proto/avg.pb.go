...
func (x *AvgResponse) GetAverage() float64 {
	if x != nil {
		return x.Average
	}
	return 0
...
const file_avg_proto_rawDesc = "" +
	...
	"\vAvgResponse\x12\x18\n" +
	"\aaverage\x18\x01 \x01(\x01R\aaverageB7Z5github.com/AshrafAaref21/grpc-golang/calculator/protob\x06proto3"
