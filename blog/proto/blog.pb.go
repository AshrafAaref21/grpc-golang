...
const file_blog_proto_rawDesc = "" +
	...
	"\n" +
	"CreateBlog\x12\n" +
	".blog.Blog\x1a\f.blog.BlogId\x120\n" +
	"\n" +
	"UpdateBlog\x12\n" +
	...
	".blog.Blog0\x01B1Z/github.com/AshrafAaref21/grpc-golang/blog/protob\x06proto3"
...
var file_blog_proto_depIdxs = []int32{
	1, // 0: blog.BlogService.ReadBlog:input_type -> blog.BlogId
